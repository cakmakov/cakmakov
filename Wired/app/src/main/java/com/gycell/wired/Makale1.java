...
public class Makale1 extends AppCompatActivity {

    private static String URL = "https://www.wired.com/2017/05/internet-week-120/";
    ...
    private class VeriGetir extends AsyncTask {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(Makale1.this);
        ...
        protected void onPostExecute(Object o) {
            ...
            TextView textView = (TextView)findViewById(R.id.makale1);
