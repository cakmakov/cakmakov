...
public class Makale4 extends AppCompatActivity {

    private static String URL = "https://www.wired.com/2017/05/shoot-360-video-like-pro-6-simple-steps/";
    ...
    private class VeriGetir extends AsyncTask {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(Makale4.this);
        ...
        protected void onPostExecute(Object o) {
            ...
            TextView textView = (TextView) findViewById(R.id.makale4);
